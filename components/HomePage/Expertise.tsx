...
const expertiseItems = [
  ...
  },
  {
    ...
    starClass: "-top-4 -left-4 animate-spin [animation-duration:12s] [filter:hue-rotate(280deg)_saturate(1.2)] dark:[filter:brightness(1.6)_hue-rotate(280deg)_saturate(1.2)]",
