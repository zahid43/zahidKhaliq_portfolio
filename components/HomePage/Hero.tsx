        ...
        <div className="container h-full">
          <div className="grid grid-cols-[1fr_1px_1fr] z-1 relative h-full">
            <div className="grid place-items-center">
              <div>
                <h5>HEY! I'm <span className="text-accent">Zahid Khaliq</span>, Frontend Engineer</h5>
            ...
            <div className="grid place-items-center">
              <div className=" relative">
                <div className="absolute top-0 left-0 w-130 h-130">
                  <div className="bg-accent w-14 h-14 rounded-2xl absolute top-14 left-5 rotate-45 animate-spin [animation-duration:10s]"></div>
                  <AvatarGraphic className="w-11/12 mt-25 ml-8" />
                  <div className="bg-violet-600 w-14 h-14 rounded-2xl absolute bottom-14 right-5 rotate-45 animate-spin [animation-duration:5s]"></div>
                </div>
                <div className="circle w-130 h-130 rounded-full bg-[#DDD9FF]"></div>
