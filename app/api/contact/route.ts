        ...
        <div style="font-family:sans-serif;max-width:600px;margin:0 auto;padding:24px;background:#f9fafb;border-radius:12px;">
          ...
          <table style="width:100%;border-collapse:collapse;">
            <tr>
              ...
              <td style="padding:8px 0;color:#1E1B4B;font-weight:600;">${safeName}</td>
            </tr>
            <tr>
              <td style="padding:8px 0;color:#6b7080;font-size:14px;">Email</td>
              <td style="padding:8px 0;color:#6366F1;"><a href="mailto:${safeEmail}" style="color:#6366F1;">${safeEmail}</a></td>
            </tr>
          </table>
          <div style="margin-top:20px;padding:16px;background:#fff;border-radius:8px;border-left:4px solid #6366F1;">
            ...
            <p style="color:#1E1B4B;margin:0;white-space:pre-wrap;">${safeMessage}</p>
          </div>
          <p style="color:#9490B8;font-size:12px;margin-top:20px;">Sent via your portfolio contact form. Reply directly to respond to ${safeName}.</p>
        </div>
      `,
    });
